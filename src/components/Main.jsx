    ...
    <div className='font-roboto'>
        ...
        <div className='hidden md:flex justify-center m-14'>
          <div className='flex justify-between text-white py-1 px-14 bg-gradient-to-r from-indigo-700 to-[#5E52F3]'>
            ...
            <img className='w-1/5 h-auto -mt-8 object-cover' src="../../src/assets/carousel-img1.png" alt="imagen 1" />

            <img className='w-1/5 -mt-10 mb-8 overflow-y-visible object-top' src="../../src/assets/carousel-img2.png" alt="imagen 2" />
